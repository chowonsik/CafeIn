...
public class CafeCurationOutput {
    ...
    @QueryProjection
    public CafeCurationOutput(Integer cafeId, String cafeName, String cafeBranch, String cafeArea, String cafeTel, String cafeAddress, String cafeLatitude, String cafeLongitude, String cafeDistance, String cafeImgUrl, Integer isBookMark, Integer bookmarkCnt, Integer reviewCnt) {
        this.cafeId = cafeId;
